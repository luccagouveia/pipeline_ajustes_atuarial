...
input_parquet_path = os.path.join(base_dir, "..", "..", ".silver", ".silver_aposentados", "step07_aposentados.parquet")
output_excel_path = os.path.join(base_dir, "..", "..", "gold", "aposentados_final.xlsx")
