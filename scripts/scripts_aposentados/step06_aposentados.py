...
input_path = ".silver/.silver_aposentados/step05_aposentados.parquet"
output_path = ".silver/.silver_aposentados/step06_aposentados.parquet"
...
def ajustar_contribuicao():
    ...
    df["VL_CONTRIBUICAO_CALCULADA"] = df["VL_APOSENTADORIA"] * 0.14

    # Aplicar regra: se VL_APOSENTADORIA == SAL_MINIMO, então VL_CONTRIBUICAO = 0
    df.loc[df["VL_APOSENTADORIA"] == SAL_MINIMO, "VL_CONTRIBUICAO_CALCULADA"] = 0
    ...
    print(df[["ID_APOSENTADO_MATRICULA", "VL_APOSENTADORIA", "VL_CONTRIBUICAO"]].head(10))
