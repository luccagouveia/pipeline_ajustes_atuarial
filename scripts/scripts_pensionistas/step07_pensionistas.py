...
input_parquet_path = os.path.join(base_dir, "..", "..", ".silver", ".silver_pensionistas", "step06_pensionistas.parquet")
output_excel_path = os.path.join(base_dir, "..", "..", "gold", "pensionistas_final.xlsx")
...
def exportar_para_excel():
    ...
    df = df.drop(columns=["idade_pensionista"], errors='ignore')
